...
- Editor cannot open Team Status. The Work Item Detail Task Dashboard follows normal Team-scoped Work Item/Task permission, so an eligible Editor can edit Tasks there. Unassigned users cannot access either surface.
...
| P3-TS-FR-039 | Team Status is hidden/denied for Editor and unassigned users. Work Item Detail Task Dashboard follows the normal Work Item/Task permission, including eligible Editor access in assigned Teams. |
...
27. Editor and unassigned users cannot open Team Status. An eligible Editor can use the Work Item Detail Task Dashboard in the assigned Team; an unassigned user cannot.
...
| P3-TS-TS-021 | Editor/unassigned user calls a Team Status mutation directly | API returns 403; a normal Work Item Task mutation is evaluated separately against Team-scoped Task permission |
