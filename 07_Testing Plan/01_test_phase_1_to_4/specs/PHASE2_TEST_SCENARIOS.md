...
| P2-BL-013 | P1 | Unassigned Backlog isolation | Open Backlog/direct item URL without that Project assignment | Project rows are hidden and direct access/mutation is denied safely | Not Run |
...
| P2-IT-017 | P1 | Unassigned user cannot open Timeboxes | Open Timeboxes/direct Iteration URL without that Project assignment | Project Iterations are hidden and direct access/mutation is denied safely | Not Run |
...
| P2-IS-023 | P1 | Unassigned Iteration Status isolation | Open Iteration Status without that Project assignment | Project/Team data is hidden and direct access/mutation is denied safely | Not Run |
