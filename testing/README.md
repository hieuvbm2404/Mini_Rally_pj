...
This folder collects BA/UAT, regression and future automation-ready test documentation for Mini Rally.
...
`Team Board` is intentionally preserved in Future Backlog only. It is not required for the current Agile management MVP test pass.
